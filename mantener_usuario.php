...
<head>
    ...
    <link rel="stylesheet" href="catalogo.js">
</head>
<body>
     <!-- Barra de navegación -->
<nav class="site-navigation">
    ...
    <body background="img/img/libro.jpeg"></body>
    <div class="form_sesion">
        <form action="registro.php" method="post">
            ...
            <br><br>
            <input type="text" name="apellido" id="apellido" placeholder="Apellido del usuario" required>
            <br><br>
            <input type="text" name="email" id="email" placeholder="Email del usuario" required>
            <br><br>
            <input id="enviar1" type="submit" value="Enviar">
            <input id="enviar1" type="submit" value="Modificar">
            <input id="enviar1" taype="submit" value="Eliminar">
            <input id="enviar1" type="submit" value="Consultar">
          </form>
    </div>
</body>
<!-- Footer -->
